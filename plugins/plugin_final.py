...
class BalancedGhostSieve:
    ...
    - probation for new / uncertain objects

    - protected for objects with convincing reuse

    - ghost remembers recent evictions and their origin



    Design goals:

    - keep SIEVE-style scan resistance

    - avoid over-filtering medium-gap reuse

    - adapt gently, not violently

    - keep runtime cheap in Python
    ...
    def _adapt(self) -> None:
        ...
        # If probation evictions come back, probation is too small.
        ...
        # If protected evictions come back, protected is too small.
        ...
        # If protected is producing lots of useful hits, keep more room there.
        ...
        # In scan-heavy phases, allow a slightly larger probation.
    ...
    def _add_probation(self, obj_id: int, obj_size: int, hit_count: int, last_touch_epoch: int) -> None:
    ...
    def _demote_protected_overflow(self) -> None:
        ...
        Before fully evicting protected items, demote cold protected LRU

        into warm probation. This helps medium-gap reuse without permanently
        ...
        # Move just enough to calm protected pressure.

        while self.protected and self.protected_bytes > protected_target:
    ...
    def on_hit(self, req: Request) -> None:
        ...
        if rec is not None:
            ...
            obj_size, _ref_bit = rec

            # Refresh recency inside protected.

            self.protected[obj_id] = [obj_size, 1]
        ...
        # Defensive metadata recovery, but keep it conservative.
    ...
    def on_miss(self, req: Request) -> None:
        ...
        if ghost_rec is not None:
            ...
            # Only direct-protect very recent protected comebacks.
